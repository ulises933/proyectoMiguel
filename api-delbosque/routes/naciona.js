...
const schema = Joi.object({ 
    ...
    UUID: Joi.string().guid().allow('').required(),
    })),
    Mercancias: Joi.array().items(
    Joi.object({
    NumeroContenedor: Joi.string().max(12).allow('').required(),
    ...
    PesoEnKg: Joi.number().presicion(6).required(),
    CantidadTransporta: Joi.array().items(
        Joi.object({
        CantidadTrans: Joi.number().presicion(6).required(),
        ...
        DetalleMercancia: Joi.Array().items(
            ...
            PesoNeto: Joi.number().presicion(6).required(),
            PesoTara: Joi.number().presicion(6).required(),
        ...
        DetalleFactura: Joi.Array().items(
            ...
            Cantidad: Joi.number().presicion(6).required(),
            })),//Fin Detalle Factura
        })),//Fin Detalle Mercancia
        Contenedor: Joy.Array().items(
            Joi.object({
